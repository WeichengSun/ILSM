...
Detailed algorithms: [ig_icmotif_count_algorithm](https://github.com/WeichengSun/ILSM/blob/main/doc/ig_icmotif_count_algorithm.pdf), [ig_icmotif_role_algorithm](https://github.com/WeichengSun/ILSM/blob/main/doc/ig_icmotif_role_algorithm.pdf).
